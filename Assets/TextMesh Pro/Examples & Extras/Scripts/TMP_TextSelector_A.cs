...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextMeshPro.rectTransform, Input.mousePosition, CamTest.main))
            {
            ...
            if (m_isHoveringObject)
            {
                ...
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, Input.mousePosition, CamTest.main, true);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextMeshPro, Input.mousePosition, CamTest.main);
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    wordPOS = CamTest.main.WorldToScreenPoint(wordPOS);
